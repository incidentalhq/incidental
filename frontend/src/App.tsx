...
import SettingsFields from '@/pages/Settings/Fields/Index'
...
import SettingsRoles from '@/pages/Settings/Roles/Index'
import SettingsSeverity from '@/pages/Settings/Severity/Index'
import SettingsSlack from '@/pages/Settings/Slack'
import SettingsStatuses from '@/pages/Settings/Statuses'
import SettingsTimestamps from '@/pages/Settings/Timestamps/Index'
import SettingsIncidentTypes from '@/pages/Settings/Types/Types'
