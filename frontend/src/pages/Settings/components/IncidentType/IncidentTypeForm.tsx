...
import SelectListField, { type Item as SelectItem } from '@/components/Form/SelectList'
...
const toSelectListItems = (fields: IField[]) => fields.map((it) => ({ id: it.id, label: it.label }))
      ...
      {({ isSubmitting }) => (
        <Form className="space-y-2">
          ...
          <div>
            ...
            <span>A short descriptive name for this incident type</span>
          </div>
          <div>
